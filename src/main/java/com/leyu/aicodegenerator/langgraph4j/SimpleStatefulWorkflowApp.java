...
public class SimpleStatefulWorkflowApp {
    ...
    static AsyncNodeAction<MessagesState<String>> makeStatefulNode(String nodeName, String message) {
        return node_async(state -> {
            ...
            log.info("Execute Node: {} - {}", nodeName, message);
            // 只记录当前步骤，不做具体的状态流转
            if (context != null) {
    ...
    public static void main(String[] args) throws GraphStateException {
        ...
        CompiledGraph<MessagesState<String>> workflow = new MessagesStateGraph<String>()
                // 添加节点 - 使用带状态感知的节点
                .addNode("image_collector", makeStatefulNode("image_collector", "Image Search"))
                .addNode("prompt_enhancer", makeStatefulNode("prompt_enhancer", "Prompt Enhancement"))
                .addNode("router", makeStatefulNode("router", "Route Selection"))
                .addNode("code_generator", makeStatefulNode("code_generator", "Code Generation"))
                .addNode("project_builder", makeStatefulNode("project_builder", "Project Construction"))
