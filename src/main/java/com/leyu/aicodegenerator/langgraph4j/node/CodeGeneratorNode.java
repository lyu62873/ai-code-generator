...
public class CodeGeneratorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            log.info("Execute CodeGeneratorNode");
            ...
            log.info("Start generating codes，Type: {} ({})", generationType.getValue(), generationType.getText());
            ...
            log.info("AI Code generation complete，create directory: {}", generatedCodeDir);
